...
> This document captures the developed design system as built — type hierarchy, color rules, interaction model, and component specs. See [Design Intent 1 (Original)](design-intent-1.md) for the personal statement and moodboard.
